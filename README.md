...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/excitingtools-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/excitingtools-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add excitingtools
# for installing globally
pixi global install excitingtools
```
...
It is possible to list all of the versions of `excitingtools` available on your platform:
...
```
pixi search excitingtools --channel conda-forge
```
